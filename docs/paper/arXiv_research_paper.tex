...
This architecture powers the production \texttt{lixSearch} system at \texttt{search.elixpo.com}, serving an 89.3\% cache hit rate with just 1.38\,MB of Redis memory---enabling conversations that persist indefinitely across sessions, server restarts, and horizontal scaling events.
...
{\footnotesize \textbf{License.} This paper is licensed under \href{https://creativecommons.org/licenses/by-nc-nd/4.0/}{CC BY-NC-ND 4.0}. You may share this work with attribution, but you may not modify it or use it commercially. The \texttt{lixSearch} software is separately licensed under MIT. \textcopyright~2026 Ayushman Bhattacharya.}
