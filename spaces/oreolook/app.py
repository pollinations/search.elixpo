...
.chat-card,.panel{background:var(--paper)!important;border:1px solid var(--line)!important;border-radius:18px!important;box-shadow:var(--shadow)!important}.chat-card{height:calc(100dvh - 126px)!important;min-height:570px!important;max-height:760px!important;padding:10px!important;overflow:hidden!important;border-radius:22px!important;position:relative!important;display:flex!important;flex-direction:column!important;gap:0!important}.panel{padding:16px!important;box-shadow:0 9px 32px rgba(58,45,34,.055)!important}
...
@media(max-width:960px){.workspace{flex-direction:column!important}.workspace>div{width:100%!important;min-width:0!important}.research-rail{display:grid!important;grid-template-columns:1fr 1fr!important}.hero{grid-template-columns:1fr;gap:18px}.hero h1{font-size:44px}.chat-card{height:calc(100dvh - 118px)!important;min-height:540px!important;max-height:700px!important}}
@media(max-width:640px){.topbar,.hero,.workspace{width:calc(100% - 26px)!important}.topbar{min-height:62px}.toplinks a:not(:first-child){display:none}.workspace{padding-top:14px!important}.hero{padding:28px 0 34px}.hero h1{font-size:37px}.hero p{font-size:14px}.research-rail{display:flex!important}.chat-card{height:calc(100dvh - 92px)!important;min-height:500px!important;max-height:650px!important}.chat-heading small{display:none}.send-btn{min-width:82px!important}.composer-row{align-items:stretch!important}.feature-list{grid-template-columns:1fr}}
"""
    ...
    with gr.Row(elem_classes="workspace"):
        with gr.Column(scale=8, min_width=560):
            with gr.Column(elem_classes="chat-card"):
                ...
                chatbot = gr.Chatbot(
                    value=[], height=None, min_height=0, max_height="100%", show_label=False,
                    placeholder=(
