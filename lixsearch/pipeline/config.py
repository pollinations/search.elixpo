...
DEEP_SEARCH_MAX_WEB_SEARCHES_PER_SUB = 1
DEEP_SEARCH_WEB_SEARCH_CONCURRENCY = 2
DEEP_SEARCH_WEB_SEARCH_TIMEOUT_SECONDS = 20
...
GRAPH_MEMORY_ENABLED = os.getenv("GRAPH_MEMORY_ENABLED", "false").lower() in {"1", "true", "yes"}
GRAPH_MEMORY_REDIS_DB = int(os.getenv("GRAPH_MEMORY_REDIS_DB", "5"))
GRAPH_MEMORY_CACHE_TTL_SECONDS = max(60, int(os.getenv("GRAPH_MEMORY_CACHE_TTL_SECONDS", "3600")))
GRAPH_MEMORY_MAX_ITEMS = max(1, min(int(os.getenv("GRAPH_MEMORY_MAX_ITEMS", "8")), 24))
GRAPH_MEMORY_MAX_CHARS = max(256, min(int(os.getenv("GRAPH_MEMORY_MAX_CHARS", "2000")), 8000))
GRAPH_MEMORY_RETRY_LIMIT = max(1, min(int(os.getenv("GRAPH_MEMORY_RETRY_LIMIT", "8")), 32))
DOCTOR_APPROVAL_SECRET = os.getenv("DOCTOR_APPROVAL_SECRET", "")
DOCTOR_ALLOW_GLOBAL = os.getenv("DOCTOR_ALLOW_GLOBAL", "false").lower() in {"1", "true", "yes"}
DOCTOR_CANDIDATE_TTL_SECONDS = max(3600, int(os.getenv("DOCTOR_CANDIDATE_TTL_SECONDS", str(7 * 86400))))
DOCTOR_AUDIT_TTL_SECONDS = max(86400, int(os.getenv("DOCTOR_AUDIT_TTL_SECONDS", str(90 * 86400))))
GRAPH_MEMORY_FACT_TTL_SECONDS = max(
    86400, int(os.getenv("GRAPH_MEMORY_FACT_TTL_SECONDS", str(365 * 86400)))
)
JANITOR_ENABLED = os.getenv("JANITOR_ENABLED", "true").lower() in {"1", "true", "yes"}
JANITOR_INTERVAL_SECONDS = max(60, int(os.getenv("JANITOR_INTERVAL_SECONDS", str(6 * 3600))))
JANITOR_LOCK_SECONDS = max(30, int(os.getenv("JANITOR_LOCK_SECONDS", "900")))
JANITOR_INACTIVE_SECONDS = max(60, int(os.getenv("JANITOR_INACTIVE_SECONDS", "3600")))
JANITOR_TRANSCRIPT_MAX_TURNS = max(20, int(os.getenv("JANITOR_TRANSCRIPT_MAX_TURNS", "200")))
JANITOR_QUEUE_RETENTION_SECONDS = max(
    3600, int(os.getenv("JANITOR_QUEUE_RETENTION_SECONDS", str(7 * 86400)))
)
JANITOR_DEAD_LETTER_MAX_ITEMS = max(
    10, int(os.getenv("JANITOR_DEAD_LETTER_MAX_ITEMS", "500"))
)
JANITOR_REVOCATION_GRACE_SECONDS = max(
    0, int(os.getenv("JANITOR_REVOCATION_GRACE_SECONDS", str(7 * 86400)))
)
JANITOR_REPORT_TTL_SECONDS = max(
    3600, int(os.getenv("JANITOR_REPORT_TTL_SECONDS", str(30 * 86400)))
)
